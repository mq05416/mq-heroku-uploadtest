								...
								<tbody>
									...
									<s:iterator value="categories">
										<tr class="odd gradeX">
											...
											<td class="center"><a
												href="edit_category_view?ma_the_loai=<s:property value="categoryID" />">Edit</a></td>
											<td class="center"><a
												href="delete_category?ma_the_loai=<s:property value="categoryID" />">Delete</a></td>
										</tr>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form role="form" action="editcategory">
									...
									<div class="form-group">
										...
										<s:textfield value="%{category.categoryName}" name="tentheloai" class="form-control"/>
									...
									<div class="form-group">
										<label>Mô tả</label>
										<textarea class="form-control" rows="3" name="mota"><s:property
												value="category.categoryDesc" /></textarea>
									</div>
