								...
								<tbody>
									...
									<s:iterator value="products">
										<tr class="odd gradeX">
											...
											<td><s:property value="productImg" /></td>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form role="form" action="edit_product">
									<div class="form-group">
										<label>Mã sản phẩm</label> <input class="form-control"
											name="productID" value=<s:property value="product.productID" /> >

									</div>
									<div class="form-group">
										<label>Tên sản phẩm</label> <input class="form-control"
											name="productName" value=<s:property value="product.productName" />>
									...
									<div class="form-group">
										<label>Mô tả</label>
										<textarea class="form-control" rows="3" name="productDesc"><s:property value="product.productDesc" /></textarea>
									</div>

									<div class="form-group">
										<label>Hình ảnh</label>
										<textarea class="form-control" rows="3" name="productImg"><s:property value="product.productImg" /></textarea>
									</div>

									<div class="form-group">
										<label>Giá cả</label>
										<textarea class="form-control" rows="3" name="productPrice" ><s:property value="product.productPrice" /></textarea>
									</div>
